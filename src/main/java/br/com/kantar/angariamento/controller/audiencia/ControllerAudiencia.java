 ...
 */
package br.com.kantar.angariamento.controller.audiencia;
...
import br.com.kantar.angariamento.servico.audiencia.AudienciaServicos;
import java.io.File;
...
public class ControllerAudiencia {
       ...
       return new AudienciaServicos().obterAudienciaIndividual(p_entrypoint, p_array_canais);
    ...
    return new AudienciaServicos().obterAudienciaDomiciliar(p_entrypoint_raw_string, p_array_canais);
    ...
    return new AudienciaServicos().fornecerListaAudiencia(p_contentmap, p_array_canais);
